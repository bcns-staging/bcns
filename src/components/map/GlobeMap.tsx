...
export default function GlobeMap() {
  ...
  useEffect(() => {
    ...
    map.on("click", async (e) => {
      // A click on a marker dot bubbles up as the map's own click event too
      // (that's how MapLibre's own Marker popup-toggle works - it listens
      // on the map's click and checks the target, rather than a separate
